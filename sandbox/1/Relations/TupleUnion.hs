...
-- generated code 'Tools.TuplesGen.Main' was called with args 'union 10'
instance TupleUnion () () () where
    tunion () () = ()
instance TupleUnion () (OneTuple (a1)) (OneTuple (a1)) where
    tunion () (OneTuple (a1)) = (OneTuple (a1))
instance TupleUnion () (a1, a2) (a1, a2) where
    tunion () (a1, a2) = (a1, a2)
instance TupleUnion () (a1, a2, a3) (a1, a2, a3) where
    tunion () (a1, a2, a3) = (a1, a2, a3)
