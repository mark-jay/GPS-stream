...
module RMC.Protobuf.RMC.RMC.ModeInd (ModeInd(..)) where
import Prelude ((+), (.))
...
instance P'.Enum ModeInd where
  ...
  fromEnum E = 2
  fromEnum N = 3
  toEnum = P'.fromMaybe (P'.error "hprotoc generated code: toEnum failure for type RMC.Protobuf.RMC.RMC.ModeInd") . toMaybe'Enum
  succ A = D
  succ D = E
  succ E = N
  succ _ = P'.error "hprotoc generated code: succ failure for type RMC.Protobuf.RMC.RMC.ModeInd"
  pred D = A
  pred E = D
  pred N = E
  pred _ = P'.error "hprotoc generated code: pred failure for type RMC.Protobuf.RMC.RMC.ModeInd"
...
instance P'.ReflectEnum ModeInd where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".RMC.RMC.ModeInd") ["RMC", "Protobuf"] ["RMC", "RMC"] "ModeInd")
      ["RMC", "Protobuf", "RMC", "RMC", "ModeInd.hs"]
      [(0, "A"), (1, "D"), (2, "E"), (3, "N")]